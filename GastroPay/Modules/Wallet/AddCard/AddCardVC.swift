***REMOVED***
***REMOVED***  AddCardVC.swift
***REMOVED***  Wallet
***REMOVED***
***REMOVED***  Created by Emrah Multinet on 9.01.2020.
...
***REMOVED*** MARK: - This will change because there is not validator class for textfield types in GastroPay
