...
public final class TransactionsVC: MIViewController {
    ...
    public override func viewWillDisappear(_ animated: Bool) {
        ...
        ***REMOVED***navigationController?.setNavigationBarHidden(false, animated: animated)
        ***REMOVED***Service.getTabbarController()?.navigationController?.setNavigationBarHidden(false, animated: animated)
    }
