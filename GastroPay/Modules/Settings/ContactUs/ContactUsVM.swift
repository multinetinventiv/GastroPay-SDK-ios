...
class ContactUsVM: NSObject {
    ...
    public var navigationTitleText = Localization.Settings.contactUsTitle.local
    ...
    var onSelectCell: ((ContactUsCellType) -> ())? = nil
...
extension ContactUsVM: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, ContactUsReusableViewProtocol {
    ...
    public func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        headerView.pageType = .contactUs
        
        return headerView
    }
    
    public func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, referenceSizeForHeaderInSection section: Int) -> CGSize {
        return CGSize(width: viewController.view.frame.width, height: 290)
    }
    
    func cellTapped(row: Int) {
        onSelectCell?(ContactUsCellType(rawValue: row)!)
    }
}
