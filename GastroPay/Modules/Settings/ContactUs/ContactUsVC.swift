...
public class ContactUsVC: MIViewController {
    ...
    func callCallCenter() {
        ...
        if let url = URL(string: "tel:***REMOVED***\(phoneNumber)"), UIApplication.shared.canOpenURL(url) {
