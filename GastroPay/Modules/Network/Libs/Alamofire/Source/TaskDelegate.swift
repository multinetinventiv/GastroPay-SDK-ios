...
***REMOVED***/ The task delegate is responsible for handling all delegate callbacks for the underlying task as well as
***REMOVED***/ executing all operations attached to the serial operation queue upon task completion.
open class TaskDelegate: NSObject {

    ***REMOVED*** MARK: Properties

    ***REMOVED***/ The serial operation queue used to execute all operations after the task completes.
    public let queue: OperationQueue

    ***REMOVED***/ The data returned by the server.
    public var data: Data? { return nil }

    ***REMOVED***/ The error generated throughout the lifecyle of the task.
    ...
    var metrics: AnyObject? ***REMOVED*** URLSessionTaskMetrics
