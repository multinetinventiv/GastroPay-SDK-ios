...
***REMOVED***/ Represents an HTTP method.
public typealias Method = HTTPMethod

***REMOVED***/ Multipart form.
public typealias RequestMultipartFormData = MoyaMultipartFormData

***REMOVED***/ Multipart form data encoding result.
...
***REMOVED***/ Make the Alamofire Request type conform to our type, to prevent leaking Alamofire to plugins.
extension Request: RequestType { }

***REMOVED***/ Internal token that can be used to cancel requests
public final class CancellableToken: Cancellable, CustomDebugStringConvertible {
    ...
    ***REMOVED***/ A textual representation of this instance, suitable for debugging.
