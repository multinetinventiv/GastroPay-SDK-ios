...
***REMOVED***/ Used for stubbing responses.
public enum EndpointSampleResponse {

    ***REMOVED***/ The network returned a response, including status code and data.
    case networkResponse(Int, Data)

    ***REMOVED***/ The network returned response which can be fully customized.
    case response(HTTPURLResponse, Data)

    ***REMOVED***/ The network failed to send the request, or failed to retrieve a response (eg a timeout).
    case networkError(NSError)
}

***REMOVED***/ Class for reifying a target of the `Target` enum unto a concrete `Endpoint`.
***REMOVED***/ - Note: As of Moya 11.0.0 Endpoint is no longer generic.
***REMOVED***/   Existing code should work as is after removing the generic.
***REMOVED***/   See #1529 and #1524 for the discussion.
open class Endpoint {
    public typealias SampleResponseClosure = () -> EndpointSampleResponse

    ***REMOVED***/ A string representation of the URL for the request.
    public let url: String

    ***REMOVED***/ A closure responsible for returning an `EndpointSampleResponse`.
    public let sampleResponseClosure: SampleResponseClosure

    ***REMOVED***/ The HTTP method for the request.
    public let method: Method

    ***REMOVED***/ The `Task` for the request.
    public let task: Task

    ***REMOVED***/ The HTTP header fields for the request.
    ...
    ***REMOVED***/ Convenience method for creating a new `Endpoint` with the same properties as the receiver, but with added HTTP header fields.
    ...
    ***REMOVED***/ Convenience method for creating a new `Endpoint` with the same properties as the receiver, but with replaced `task` parameter.
...
***REMOVED***/ Extension for converting an `Endpoint` into a `URLRequest`.
extension Endpoint {
    ***REMOVED*** swiftlint:disable cyclomatic_complexity
    ***REMOVED***/ Returns the `Endpoint` converted to a `URLRequest` if valid. Throws an error otherwise.
    ...
    ***REMOVED*** swiftlint:enable cyclomatic_complexity
}

***REMOVED***/ Required for using `Endpoint` as a key type in a `Dictionary`.
extension Endpoint: Equatable, Hashable {
    ...
    ***REMOVED***/ Note: If both Endpoints fail to produce a URLRequest the comparison will
    ***REMOVED***/ fall back to comparing each Endpoint's hashValue.
