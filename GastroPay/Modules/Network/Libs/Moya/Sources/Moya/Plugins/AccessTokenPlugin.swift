...
***REMOVED*** MARK: - AccessTokenAuthorizable

***REMOVED***/ A protocol for controlling the behavior of `AccessTokenPlugin`.
public protocol AccessTokenAuthorizable {

    ***REMOVED***/ Represents the authorization header to use for requests.
    var authorizationType: AuthorizationType { get }
}

***REMOVED*** MARK: - AuthorizationType

***REMOVED***/ An enum representing the header to use with an `AccessTokenPlugin`
public enum AuthorizationType {
    ***REMOVED***/ No header.
    case none

    ***REMOVED***/ The `"Basic"` header.
    case basic

    ***REMOVED***/ The `"Bearer"` header.
    case bearer
...
***REMOVED*** MARK: - AccessTokenPlugin
...
public struct AccessTokenPlugin: PluginType {
    ...
    ***REMOVED***/ A closure returning the access token to be applied in the header.
