...
***REMOVED***/ Logs network activity (outgoing requests and incoming responses).
public final class NetworkLoggerPlugin: PluginType {
    ...
    ***REMOVED***/ A Boolean value determing whether response body data should be logged.
    public let isVerbose: Bool
    public let cURL: Bool

    ***REMOVED***/ Initializes a NetworkLoggerPlugin.
