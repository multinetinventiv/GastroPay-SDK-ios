...
***REMOVED***/ Represents a response to a `MoyaProvider.request`.
public final class MResponse: CustomDebugStringConvertible, Equatable {

    ***REMOVED***/ The status code of the response.
    public let statusCode: Int

    ***REMOVED***/ The response data.
    public let data: Data

    ***REMOVED***/ The original URLRequest for the response.
    public let request: URLRequest?

    ***REMOVED***/ The HTTPURLResponse object.
    ...
    ***REMOVED***/ A text description of the `Response`.
    public var description: String {
        return "Status Code: \(statusCode), Data Length: \(data.count)"
    }

    ***REMOVED***/ A text description of the `Response`. Suitable for debugging.
    public var debugDescription: String {
        return description
    }

    public static func == (lhs: MResponse, rhs: MResponse) -> Bool {
...
public extension MResponse {
    ...
    */
    func filter<R: RangeExpression>(statusCodes: R) throws -> MResponse where R.Bound == Int {
    ...
    /**
     ...
     - throws: `MoyaError.statusCode` when others are encountered.
    */
    func filter(statusCode: Int) throws -> MResponse {
    ...
    /**
     ...
     - throws: `MoyaError.statusCode` when others are encountered.
    */
    func filterSuccessfulStatusCodes() throws -> MResponse {
    ...
    /**
     ...
     - throws: `MoyaError.statusCode` when others are encountered.
    */
    func filterSuccessfulStatusAndRedirectCodes() throws -> MResponse {
        return try filter(statusCodes: 200...399)
    }

    ***REMOVED***/ Maps data received from the signal into an Image.
    ...
    ***REMOVED***/ Maps data received from the signal into a JSON object.
    ***REMOVED***/
    ***REMOVED***/ - parameter failsOnEmptyData: A Boolean value determining
    ***REMOVED***/ whether the mapping should fail if the data is empty.
    ...
    ***REMOVED***/ Maps data received from the signal into a String.
    ***REMOVED***/
    ***REMOVED***/ - parameter atKeyPath: Optional key path at which to parse string.
    func mapString(atKeyPath keyPath: String? = nil) throws -> String {
        if let keyPath = keyPath {
            ***REMOVED*** Key path was provided, try to parse string at key path
            ...
            ***REMOVED*** Key path was not provided, parse entire response as string
    ...
    ***REMOVED***/ Maps data received from the signal into a Decodable object.
    ***REMOVED***/
    ***REMOVED***/ - parameter atKeyPath: Optional key path at which to parse object.
    ***REMOVED***/ - parameter using: A `JSONDecoder` instance which is used to decode data to an object.
