...
extension LoginVC {
    ...
    func textFieldChanged(textField: UITextField){
        ...
        self.viewModel.phoneNumber = phoneNumberString ***REMOVED***(textField.text?.components(separatedBy: CharacterSet.decimalDigits.inverted).joined()) ?? ""
