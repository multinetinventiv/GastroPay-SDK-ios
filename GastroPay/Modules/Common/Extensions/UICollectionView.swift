***REMOVED***
***REMOVED***  UICollectionView.swift
***REMOVED***  Alamofire
***REMOVED***
***REMOVED***  Created by  on 20.12.2019.
***REMOVED***
...
public extension UITableView {
    ...
    ***REMOVED***/ Register given `UITableViewCell` in tableView.
    ***REMOVED***/ Cell will be registered with the name of it's class as identifier.
    ...
    ***REMOVED***/ Dequeue cell of given class from tableView.
