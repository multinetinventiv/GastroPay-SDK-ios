***REMOVED***
***REMOVED***  ESTabBarContentView.swift
***REMOVED***
...
public enum ESTabBarItemContentMode : Int {
    ...
    case alwaysOriginal ***REMOVED*** Always set the original image size
    
    case alwaysTemplate ***REMOVED*** Always set the image as a template image size
}


open class ESTabBarItemContentView: UIView {
    
    ***REMOVED*** MARK: - PROPERTY SETTING

    ***REMOVED***/ 设置contentView的偏移
    ...
    ***REMOVED***/ Icon imageView renderingMode, default is .alwaysTemplate like UITabBarItem
    ...
    ***REMOVED***/ Item content mode, default is .alwaysTemplate like UITabBarItem
    ...
    ***REMOVED***/ Icon imageView's image
    ...
    ***REMOVED*** MARK: -
    ...
    open func updateLayout() {
        ...
        if self.itemContentMode == .alwaysTemplate {
            var s: CGFloat = 0.0 ***REMOVED*** image size
            var f: CGFloat = 0.0 ***REMOVED*** font
            var isLandscape = false
            if let keyWindow = UIApplication.shared.keyWindow {
                isLandscape = keyWindow.bounds.width > keyWindow.bounds.height
            }
            let isWide = isLandscape || traitCollection.horizontalSizeClass == .regular ***REMOVED*** is landscape or regular
    ...
    ***REMOVED*** MARK: - ANIMATION METHODS
