...
open class ESTabBarController: UITabBarController, ESTabBarDelegate {
    ...
    ***REMOVED***/ 当前tabBarController是否存在"More"tab
    ...
    ***REMOVED***/ Ignore next selection or not.
    fileprivate var ignoreNextSelection = false

    ***REMOVED***/ Should hijack select action or not.
    open var shouldHijackHandler: ESTabBarControllerShouldHijackHandler?
    ***REMOVED***/ Hijack select action.
    open var didHijackHandler: ESTabBarControllerDidHijackHandler?
    
    ***REMOVED***/ Observer tabBarController's selectedViewController. change its selection when it will-set.
    open override var selectedViewController: UIViewController? {
        willSet {
            guard let newValue = newValue else {
                ***REMOVED*** if newValue == nil ...
                return
            }
    ...
    ***REMOVED***/ Observer tabBarController's selectedIndex. change its selection when it will-set.
    ...
    ***REMOVED***/ Customize set tabBar use KVC.
    ...
    ***REMOVED*** MARK: - UITabBar delegate
    ...
    ***REMOVED*** MARK: - ESTabBar delegate
