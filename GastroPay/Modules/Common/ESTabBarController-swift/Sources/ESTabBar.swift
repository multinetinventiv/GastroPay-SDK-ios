...
***REMOVED***/ 对原生的UITabBarItemPositioning进行扩展，通过UITabBarItemPositioning设置时，系统会自动添加insets，这使得添加背景样式的需求变得不可能实现。ESTabBarItemPositioning完全支持原有的item Position 类型，除此之外还支持完全fill模式。
***REMOVED***/
***REMOVED***/ - automatic: UITabBarItemPositioning.automatic
***REMOVED***/ - fill: UITabBarItemPositioning.fill
***REMOVED***/ - centered: UITabBarItemPositioning.centered
***REMOVED***/ - fillExcludeSeparator: 完全fill模式，布局不覆盖tabBar顶部分割线
***REMOVED***/ - fillIncludeSeparator: 完全fill模式，布局覆盖tabBar顶部分割线
...
***REMOVED***/ 对UITabBarDelegate进行扩展，以支持UITabBarControllerDelegate的相关方法桥接
internal protocol ESTabBarDelegate: NSObjectProtocol {

    ***REMOVED***/ 当前item是否支持选中
    ***REMOVED***/
    ***REMOVED***/ - Parameters:
    ***REMOVED***/   - tabBar: tabBar
    ***REMOVED***/   - item: 当前item
    ***REMOVED***/ - Returns: Bool
    func tabBar(_ tabBar: UITabBar, shouldSelect item: UITabBarItem) -> Bool
    
    ***REMOVED***/ 当前item是否需要被劫持
    ***REMOVED***/
    ***REMOVED***/ - Parameters:
    ***REMOVED***/   - tabBar: tabBar
    ***REMOVED***/   - item: 当前item
    ...
    ***REMOVED***/ 当前item的点击被劫持
    ***REMOVED***/
    ***REMOVED***/ - Parameters:
    ***REMOVED***/   - tabBar: tabBar
    ***REMOVED***/   - item: 当前item
    ***REMOVED***/ - Returns: Void
    func tabBar(_ tabBar: UITabBar, didHijack item: UITabBarItem)
}



***REMOVED***/ ESTabBar是高度自定义的UITabBar子类，通过添加UIControl的方式实现自定义tabBarItem的效果。目前支持tabBar的大部分属性的设置，例如delegate,items,selectedImge,itemPositioning,itemWidth,itemSpacing等，以后会更加细致的优化tabBar原有属性的设置效果。
open class ESTabBar: UITabBar {

    internal weak var customDelegate: ESTabBarDelegate?
    
    ***REMOVED***/ tabBar中items布局偏移量
    public var itemEdgeInsets = UIEdgeInsets.zero
    ***REMOVED***/ 是否设置为自定义布局方式，默认为空。如果为空，则通过itemPositioning属性来设置。如果不为空则忽略itemPositioning,所以当tabBar的itemCustomPositioning属性不为空时，如果想改变布局规则，请设置此属性而非itemPositioning。
    ...
    ***REMOVED***/ tabBar自定义item的容器view
    internal var containers = [ESTabBarItemContainer]()
    ***REMOVED***/ 缓存当前tabBarController用来判断是否存在"More"Tab
    internal weak var tabBarController: UITabBarController?
    ***REMOVED***/ 自定义'More'按钮样式，继承自ESTabBarItemContentView
...
internal extension ESTabBar /* Layout */ {
    ...
    func updateLayout() {
        ...
        if layoutBaseSystem {
            ***REMOVED*** System itemPositioning
            ...
            ***REMOVED*** Custom itemPositioning
            ...
            let height = bounds.size.height - y 
            let eachWidth = itemWidth == 0.0 ? width / CGFloat(containers.count) : itemWidth
            let eachSpacing = itemSpacing == 0.0 ? 0.0 : itemSpacing
            
            for container in containers {
                container.frame = CGRect.init(x: x, y: y - itemEdgeInsets.bottom, width: eachWidth, height: height)
                x += eachWidth
                x += eachSpacing
            }
        }
