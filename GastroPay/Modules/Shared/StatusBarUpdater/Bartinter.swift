...
private extension UIImage {
    var averageLuminance: CGFloat? {
        ...
        ***REMOVED*** Luminance coeficents taken from https:***REMOVED***en.wikipedia.org/wiki/Relative_luminance
...
public extension UIViewController {
    var statusBarUpdater: Bartinter? {
        ...
        set {
            ***REMOVED*** Dispatching to next runloop iteration
            DispatchQueue.main.async {
