...
public extension MIPopupManager {
    ...
    func openPuanEarnedPopup(amount: String) {
        ...
        //popupView.bodyLabel.text = Localization.Popups.puanEarnedBody.local.replacingOccurrences(of: "%1$s", with: String(format: "%.2f", amount))
