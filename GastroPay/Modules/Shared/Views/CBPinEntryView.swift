***REMOVED***
***REMOVED***  CBPinEntryView.swift
***REMOVED***  Shared
***REMOVED***
***REMOVED***  Created by  on 6.01.2020.
...
open class CBPinEntryView: UIView {
    ...
    private func setupStackView() {
        ...
        ***REMOVED*** stackView!.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 0).isActive = true
        ***REMOVED*** stackView!.trailingAnchor.constraint(equalTo: trailingAnchor, constant: 0).isActive = true
