***REMOVED***
***REMOVED***  UICollectionViewPillLayout.swift
***REMOVED***  Shared
***REMOVED***
***REMOVED***  Created by  on 20.07.2020.
***REMOVED***  Copyright © 2020 Multinet. All rights reserved.
***REMOVED***

import UIKit

public class PillHeaderView: UICollectionReusableView {
...
public protocol PillLayoutDelegate: AnyObject {
...
public class PillLayout: UICollectionViewLayout {
    weak var delegate: PillLayoutDelegate?

    ***REMOVED*** Total height of the content. Will be used to configure the scrollview content
    ...
    override public func prepare() {
        ...
        ***REMOVED*** Variable to track the width of the layout at the current state when the item is being drawn
        var layoutWidthIterator: CGFloat = 0.0

        for section in 0..<collectionView.numberOfSections {
            ***REMOVED*** Get the necessary data (if implemented) from the delegates else provide default values
            ...
            ***REMOVED*** Variables to track individual item width and cumultative height of all items as they are being laid out.
            ...
            for item in 0..<collectionView.numberOfItems(inSection: section) {
                ...
                if (layoutWidthIterator + itemSize.width + insets.left + insets.right) > collectionView.frame.width {
                    ***REMOVED*** If the current row width (after this item being laid out) is exceeding the width of the collection view content, put it in the next line
