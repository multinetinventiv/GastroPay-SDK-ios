...
#
#  To learn more about Podspec attributes see https:***REMOVED***guides.cocoapods.org/syntax/podspec.html
#  To see working Podspecs in the CocoaPods repo see https:***REMOVED***github.com/CocoaPods/Specs/
#
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https:***REMOVED***github.com/multinetinventiv/GastroPay-SDK-ios-new.git"
  # spec.screenshots  = "www.example.com/screenshots_1.gif", "www.example.com/screenshots_2.gif"


  # ―――  Spec License  ――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  #
  #  Licensing your code is important. See https:***REMOVED***choosealicense.com for more info.
  ...
  # spec.social_media_url   = "https:***REMOVED***twitter.com/ilkersevim"
  spec.social_media_url   = "https:***REMOVED***inventiv.com.tr"
  ...
  spec.source       = { :git => "https:***REMOVED***github.com/multinetinventiv/GastroPay-SDK-ios-new.git", :tag => "#{spec.version}" }
