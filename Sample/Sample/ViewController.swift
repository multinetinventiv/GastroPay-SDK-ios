...
***REMOVED***MARK: - To read and write to config plist files
...
extension ViewController{
    ...
    */
    ...
    func saveToPropertyList() {
        ...
        ***REMOVED***tempDict["authenticationToken"] = self.selectedAuthToken
        
        ***REMOVED***tempDict["walletToken"] = self.selectedWalletToken
        
        tempDict.write(toFile: path!, atomically: true)
    }
}

***REMOVED***MARK: GastropayDelegate methods
